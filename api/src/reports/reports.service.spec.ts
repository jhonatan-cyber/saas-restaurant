...
import { createTestUser, createTestContext, createMockQueue } from '../test/mocks';
...
describe('ReportsService', () => {
  ...
  beforeEach(async () => {
    ...
    const result = await buildServiceTest(ReportsService, {
      extra: [{ provide: getQueueToken('reports'), useValue: queue }],
    });
