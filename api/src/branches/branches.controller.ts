...
import { createBranchSchema, updateBranchSchema, branchFiltersSchema } from '@saas/shared';
...
export class BranchesController {
  ...
  list(
    ...
    @Query(new ZodValidationPipe(branchFiltersSchema)) filters: BranchFiltersDto,
  ) {
