...
import { Role, tableFiltersSchema, createTableSchema, updateTableSchema, changeTableStatusSchema } from '@saas/shared';
...
export class TablesController {
  ...
  changeStatus(
    ...
    @BusinessContext() context: Context | undefined,
    @Param('id') id: string,
    @Body(new ZodValidationPipe(changeTableStatusSchema)) dto: ChangeTableStatusDto,
  ) {
