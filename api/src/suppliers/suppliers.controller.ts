...
import { Role, supplierFiltersSchema, createSupplierSchema, updateSupplierSchema } from '@saas/shared';
...
export class SuppliersController {
  ...
  list(
    ...
    @Query(new ZodValidationPipe(supplierFiltersSchema)) filters: SupplierFiltersDto,
  ) {
