...
import { Role, purchaseFiltersSchema, createPurchaseSchema, updatePurchaseSchema } from '@saas/shared';
...
export class PurchasesController {
  ...
  list(
    ...
    @Query(new ZodValidationPipe(purchaseFiltersSchema)) filters: PurchaseFiltersDto,
  ) {
