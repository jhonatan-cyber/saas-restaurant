...
import { Role, preparationAreaFiltersSchema, createPreparationAreaSchema, updatePreparationAreaSchema, reorderPreparationAreasSchema } from '@saas/shared';
...
export class PreparationAreasController {
  ...
  list(
    ...
    @Query(new ZodValidationPipe(preparationAreaFiltersSchema)) filters: PreparationAreaFiltersDto,
  ) {
  ...
  create(
    @CurrentUser() user: AuthenticatedUser,
    @BusinessContext() context: Context | undefined,
    @Body(new ZodValidationPipe(createPreparationAreaSchema)) dto: CreatePreparationAreaDto,
  ) {
  ...
  update(
    ...
    @BusinessContext() context: Context | undefined,
    @Param('id') id: string,
    @Body(new ZodValidationPipe(updatePreparationAreaSchema)) dto: UpdatePreparationAreaDto,
  ) {
  ...
  reorder(
    @CurrentUser() user: AuthenticatedUser,
    @BusinessContext() context: Context | undefined,
    @Body(new ZodValidationPipe(reorderPreparationAreasSchema)) dto: ReorderPreparationAreasDto,
  ) {
