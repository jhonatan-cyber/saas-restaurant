...
import { ProductGrid, OrderCartPanel, PosActiveOrders, PaymentModal, RoutePending } from '~/components';
import type { AddableProduct } from '~/components';
...
function PosPage(): ReactNode {
  ...
  const branchId = useBranchStore((s) => s.activeBranchId) ?? user.branches[0]?.id ?? null;
