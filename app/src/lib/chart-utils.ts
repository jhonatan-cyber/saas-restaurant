...
Chart.defaults.plugins.legend.labels.color = '#404040';
...
const DEFAULT_COLORS = ['#737373', '#525252', '#404040', '#262626', '#171717'];
...
export function createStackedBarChart(
  ...
  const colors = ['#737373', '#525252', '#404040', '#262626', '#171717', '#000000'];
  const cfg: ChartConfiguration<'bar'> = {
    type: 'bar',
    data: {
      labels: data.labels,
