              ...
              {user.branches.length === 0 ? null : user.branches.length === 1 ? (
                ...
                <div className="relative" ref={branchMenuRef}>
                  ...
                  >
                    ...
                    <svg className={`h-3 w-3 ml-0.5 transition-transform duration-200 ${branchMenuOpen ? 'rotate-180' : ''}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
