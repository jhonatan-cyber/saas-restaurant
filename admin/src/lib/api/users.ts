...
export const usersApi = {
  create: (data: { email: string; fullName: string; password: string; role: string; phone?: string; defaultBranchId?: string }) =>
  ...
  update: (id: string, data: { email?: string; fullName?: string; role?: string; phone?: string; defaultBranchId?: string | null }) =>
